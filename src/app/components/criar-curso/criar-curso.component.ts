...
export class CriarCursoComponent {
  ...
  criarQuestionario() {
      ...
      if (divParagrafos && divCriados) {
        ...
        btnCriar.addEventListener('click', () => {
          ...
          if (titulo.trim() && opcoes.length === 5) {
            this.nroQuestao += 1;
            const numeroQuestao = this.nroQuestao;
            ...
            const divSelectApagar = document.createElement('div');
            divSelectApagar.classList.add('col-sm-12', 'col-md-8');
            divSelectApagar.style.display = 'flex'; // Adiciona flexbox
            divSelectApagar.style.alignItems = 'center'; // Centraliza verticalmente
            ...
            divSelectApagar.appendChild(select);
    ...
    <path d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5M11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47M8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5"/>
            ...
            btnApagar.addEventListener('click', () => {
              this.nroQuestao -= 1
              divCriados.removeChild(divQuestao);
            });
  
            divSelectApagar.appendChild(btnApagar);
            divQuestao.appendChild(divSelectApagar);
